        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item active">Welcome to Receptionist Dashboard</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-7">
                        <div class="text-primary p-3">
                            ...
                            <p>Receptionist <?php echo e(__("Dashboard")); ?></p>
                        </div>
                    </div>
...
<!-- end row -->
<?php /**PATH C:\xampp\htdocs\health_care\health_care\resources\views/layouts/receptionist-dashboard.blade.php ENDPATH**/ ?>