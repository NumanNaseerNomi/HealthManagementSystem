        ...
        <?php echo $__env->yieldContent('css'); ?>
         <!-- App css -->
        <link href="<?php echo e(URL::asset('assets/css/bootstrap-dark.min.css')); ?>" id="bootstrap-dark" rel="stylesheet" type="text/css" />
        ...
        <link href="<?php echo e(URL::asset('assets/css/app-dark.min.css')); ?>" id="app-dark" rel="stylesheet" type="text/css" />
...
<?php /**PATH C:\xampp\htdocs\health_care\health_care\resources\views/layouts/head.blade.php ENDPATH**/ ?>