<?php $__env->startSection('title'); ?>
    <?php if($receptionist): ?>
        <?php echo e(__('Update Receptionist Details')); ?>

    <?php else: ?>
        <?php echo e(__('Add New Receptionist')); ?>
                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo e(url('receptionist')); ?>"><?php echo e(__('Receptionists')); ?></a>
                            </li>
            ...
            <div class="col-12">
                <?php if($receptionist): ?>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(url('receptionist/' . $receptionist->id)); ?>">
                            <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                                <i
                                    class="bx bx-arrow-back font-size-16 align-middle mr-2"></i><?php echo e(__('Back to Receptionist Profile')); ?>
                ...
                <?php else: ?>
                    <a href="<?php echo e(url('receptionist')); ?>">
                        <button type="button" class="btn btn-primary waves-effect waves-light mb-4">
                            <i
                                class="bx bx-arrow-back font-size-16 align-middle mr-2"></i><?php echo e(__('Back to Receptionist List')); ?>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php if($receptionist): ?> <?php echo e(url('receptionist/' . $receptionist->id)); ?> <?php else: ?> <?php echo e(route('receptionist.store')); ?> <?php endif; ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <?php if($receptionist): ?>
...
unset($__errorArgs, $__bag); ?>" tabindex="1"
                                                name="first_name" id="firstname" value="<?php if($receptionist): ?><?php echo e($receptionist->first_name); ?><?php elseif(old('first_name')): ?><?php echo e(old('first_name')); ?><?php endif; ?>"
...
unset($__errorArgs, $__bag); ?>"
                                                name="email" tabindex="3" id="email" value="<?php if($receptionist): ?><?php echo e($receptionist->email); ?><?php elseif(old('email')): ?><?php echo e(old('email')); ?><?php endif; ?>"
...
unset($__errorArgs, $__bag); ?>"
                                                tabindex="2" name="last_name" id="lastname" value="<?php if($receptionist): ?><?php echo e($receptionist->last_name); ?><?php elseif(old('last_name')): ?><?php echo e(old('last_name')); ?><?php endif; ?>"
...
unset($__errorArgs, $__bag); ?>"
                                                src="<?php if($receptionist && $receptionist->profile_photo != null): ?><?php echo e(URL::asset('storage/images/users/' . $receptionist->profile_photo)); ?><?php else: ?><?php echo e(URL::asset('assets/images/users/noImage.png')); ?><?php endif; ?>" id="profile_display" onclick="triggerClick()"
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\health_care\health_care\resources\views/receptionist/receptionist-details.blade.php ENDPATH**/ ?>