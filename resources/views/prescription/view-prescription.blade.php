            ...
            <div class="col-12">
                <a href="{{ url('prescription') }}">
                    <button type="button" class="btn btn-success waves-effect waves-light mb-4">
                        <i class="bx bx-arrow-back font-size-16 align-middle mr-2"></i>{{ __('Back to Prescription List') }}
                    </button>
                </a>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <address>
                                    <strong>{{ __('Prescription Date: ') }}</strong>{{ $prescription->created_at }}<br>
                                    <strong>{{ __('Appointment Date: ') }}</strong>{{ $prescription->appointment->appointment_date . ' ' . $prescription->appointment->timeSlot->form . ' ' . $prescription->appointment->timeSlot->to }}<br>
                                </address>
                            </div>
                        </div>
                        <div class="row">
