	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-8">
				...
				<img src="{{ URL::asset('hms/images/about/sign.png') }}" alt="" class="img-fluid">
			</div>
		</div>
	</div>
</section>
		...
		<div class="row">
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item mb-5 mb-lg-0">
					<img src="{{ URL::asset('hms/images/about/about-1.jpg') }}" alt="" class="img-fluid w-100">
			...
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item mb-5 mb-lg-0">
					<img src="{{ URL::asset('hms/images/about/about-2.jpg') }}" alt="" class="img-fluid w-100">
			...
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item mb-5 mb-lg-0">
					<img src="{{ URL::asset('hms/images/about/about-3.jpg') }}" alt="" class="img-fluid w-100">
			...
			<div class="col-lg-3 col-md-6">
				<div class="about-block-item">
					<img src="{{ URL::asset('hms/images/about/about-4.jpg') }}" alt="" class="img-fluid w-100">
			...
			<div class="col-lg-8">
				<div class="row">
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="award-img">
							<img src="{{ URL::asset('hms/images/about/3.png') }}" alt="" class="img-fluid">
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="award-img">
							<img src="{{ URL::asset('hms/images/about/4.png') }}" alt="" class="img-fluid">
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="award-img">
							<img src="{{ URL::asset('hms/images/about/1.png') }}" alt="" class="img-fluid">
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="award-img">
							<img src="{{ URL::asset('hms/images/about/2.png') }}" alt="" class="img-fluid">
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="award-img">
							<img src="{{ URL::asset('hms/images/about/5.png') }}" alt="" class="img-fluid">
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="award-img">
							<img src="{{ URL::asset('hms/images/about/6.png') }}" alt="" class="img-fluid">
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="team-block mb-5 mb-lg-0">
					<img src="{{ URL::asset('hms/images/team/1.jpg') }}" alt="" class="img-fluid w-100">
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="team-block mb-5 mb-lg-0">
					<img src="{{ URL::asset('hms/images/team/2.jpg') }}" alt="" class="img-fluid w-100">
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="team-block mb-5 mb-lg-0">
					<img src="{{ URL::asset('hms/images/team/3.jpg') }}" alt="" class="img-fluid w-100">
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="team-block">
					<img src="{{ URL::asset('hms/images/team/4.jpg') }}" alt="" class="img-fluid w-100">
